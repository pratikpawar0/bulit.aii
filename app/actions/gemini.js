...
// Function to try multiple model names until one works
async function getWorkingModel() {
  ...
  throw new Error("No working Gemini models available. Please check your API key and billing status.");
}
...
`;
    ...
    if (error.message?.includes("API key")) {
      return {
        success: false,
        error: "AI service configuration error. Please check your API key in settings.",
      };
    }
